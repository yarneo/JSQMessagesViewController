...
{
    UIImage *accessoryImage = [UIImage jsq_defaultFilterImage];
    UIImage *normalImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor lightGrayColor]];
    UIImage *highlightedImage = [accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
+ (UIButton *)defaultSendButtonItem
{
    ...
    sendButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Regular" size:16.f];
...
{
    NSString *sendTitle = [NSBundle jsq_localizedStringForKey:@"Definitely"];
...
//    [sendButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    ...
    sendButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Bold" size:15.f];
    sendButton.titleLabel.adjustsFontSizeToFitWidth = YES;
    sendButton.titleLabel.minimumScaleFactor = 0.85f;
    sendButton.contentMode = UIViewContentModeCenter;
    sendButton.backgroundColor = [UIColor clearColor];
...
{
    NSString *sendTitle = [NSBundle jsq_localizedStringForKey:@"I'll Pass"];
    
    UIButton *sendButton = [[UIButton alloc] initWithFrame:CGRectZero];
    [sendButton setTitle:sendTitle forState:UIControlStateNormal];
    [sendButton setTitleColor:[UIColor jsq_messageBubbleRedColor] forState:UIControlStateNormal];
    [sendButton setTitleColor:[[UIColor jsq_messageBubbleRedColor] jsq_colorByDarkeningColorWithValue:0.1f] forState:UIControlStateHighlighted];
//    [sendButton setTitleColor:[UIColor lightGrayColor] forState:UIControlStateDisabled];
    
    sendButton.titleLabel.font = [UIFont fontWithName:@"Montserrat-Light" size:15.f];
    sendButton.titleLabel.adjustsFontSizeToFitWidth = YES;
    sendButton.titleLabel.minimumScaleFactor = 0.85f;
    sendButton.contentMode = UIViewContentModeCenter;
    sendButton.backgroundColor = [UIColor clearColor];
    sendButton.tintColor = [UIColor jsq_messageBubbleRedColor];
